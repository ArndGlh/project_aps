...
INSERT INTO `user` (`ID`, `USERNAME`, `USERPASSWORD`, `USERMAIL`) VALUES (NULL, 'clement', 'clement', 'clement.correia@espi.fr'), (NULL, 'arnaud', 'arnaud', 'arnaud.guilhaumon@espi.fr'), (NULL, 'hugo', 'hugo', 'hugo.severin@espi.fr'), (NULL, 'leonard', 'leonard', 'leonard.pasquier@espi.fr');
